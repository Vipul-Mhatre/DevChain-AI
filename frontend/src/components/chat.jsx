...
const UserMessage = ({ text }) => {
  return (
    <div className="flex flex-row gap-3 items-start my-5">
      <div className="flex items-center justify-center rounded-full w-10 h-10 bg-theme-purple">
        <FaUser />
      </div>
      <div className="p-3 bg-gray-100 rounded-lg max-w-3xl">{text}</div>
    </div>
  );
};
...
const AssistantMessage = ({ text }) => {
  return (
    <div className="flex flex-row-reverse gap-3 items-start my-5">
      <div className="flex items-center justify-center rounded-full w-10 h-10 bg-theme-purple">
        <FaGithub className="text-white" />
      </div>
      <div className="p-3 bg-gray-200 rounded-lg max-w-3xl">
        <ReactMarkdown
